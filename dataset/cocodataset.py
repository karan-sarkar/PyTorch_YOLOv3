...
class COCODataset(Dataset):
    ...
    COCO dataset class.
    """
    def __init__(self, model_type, data_dir='../fcos-pytorch/bdd100k/images/100k', json_file='daytime',
        ...
        self.coco = COCO('../fcos-pytorch/' + str(json_file) + '_bdd100k_labels_images_det_coco_' + str(name) + '.json')
